...
from ultralytics.nn.modules.block import C3, C2f, RepCSP

__all__ = ['RepNCSPELAN4_CAA','PKIBlock']
...
class RepCSP_CAA(RepCSP):
    def __init__(self, c1, c2, n=1, k=7, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)  # Calculate c_ based on c2 and e
        self.m = nn.ModuleList(CAA(c_) for _ in range(n))
