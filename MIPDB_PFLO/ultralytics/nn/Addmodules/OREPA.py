...
__all__ = ['OREPA', 'C2f_OREPA','RepNCSPELAN4_OREPA']
...
class RepBottleneck_OREPA(nn.Module):
    """Rep bottleneck."""
...
class RepCSP_OREPA(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        self.m = nn.Sequential(*(RepBottleneck_OREPA(c_, c_, shortcut, g, e=1.0) for _ in range(n)))
...
class RepNCSPELAN4_OREPA(nn.Module):
    """CSP-ELAN."""
    ...
    def __init__(self, c1, c2, c3, c4, n=1):
        ...
        self.cv2 = nn.Sequential(RepCSP_OREPA(c3 // 2, c4, n), Conv(c4, c4, 3, 1))
        self.cv3 = nn.Sequential(RepCSP_OREPA(c4, c4, n), Conv(c4, c4, 3, 1))
